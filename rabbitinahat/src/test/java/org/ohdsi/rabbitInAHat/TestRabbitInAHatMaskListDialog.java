 ...
 */
@CacioTest
public class TestRabbitInAHatMaskListDialog {
    ...
    @Test
    public void hideAndVerifyTables() throws URISyntaxException {
    ...
    private void hideTables() throws URISyntaxException {
        ...
        window.dialog(MASK_LIST_DIALOG);
        window.dialog(MASK_LIST_DIALOG).textBox().setText(".csv");
        window.dialog(MASK_LIST_DIALOG).button(DESELECT_BUTTON).click();
        window.dialog(MASK_LIST_DIALOG).radioButton(REGEX_BUTTON).click();
        window.dialog(MASK_LIST_DIALOG).textBox().setText(".*co.*");
        window.dialog(MASK_LIST_DIALOG).button(SELECT_BUTTON).click();
    }
